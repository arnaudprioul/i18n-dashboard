          ...
          <template v-if="totalToImport > 0">
            ...
            <div v-if="selected.numberFormats.length">
              ...
              <div class="space-y-1">
                ...
                >
                  <u-checkbox :model-value="f.checked" @click.stop @update:model-value="f.checked = $event" />
            ...
            <div v-if="selected.modifiers.length">
              ...
              <div class="space-y-1">
                ...
                >
                  <u-checkbox :model-value="m.checked" @click.stop @update:model-value="m.checked = $event" />
