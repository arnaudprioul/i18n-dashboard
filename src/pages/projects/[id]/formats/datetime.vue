  ...
  <div class="p-6 max-w-5xl mx-auto space-y-6">
    ...
    >
      ...
      <p class="text-sm mt-1">
        {{ t('formats.add_to_use', 'Add formats to use') }} <code class="font-mono text-xs">$d()</code> {{ t('formats.in_templates', 'in your templates.') }}
      </p>
      <UButton
        class="mt-4"
        icon="i-heroicons-plus"
        ...
        <div class="space-y-4">
          ...
          <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
            ...
            <p class="text-sm font-mono font-semibold text-gray-700 dark:text-gray-300">
              {{ previewDate(cleanOptions, form.locale) }}
            </p>
          </div>
        </div>
      </template>
