    ...
    <div class="max-w-2xl space-y-6">
      ...
      <UCard>
        ...
        >
          ...
          <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 text-sm text-gray-600 dark:text-gray-400 space-y-1">
            ...
            <p>• {{ t('security.rule_min_length_pre', 'Minimum') }} {{ form.password_min_length }} {{ form.password_min_length > 1 ? t('security.rule_characters', 'characters') : t('security.rule_character', 'character') }}</p>
      ...
      <UCard>
        ...
        <div class="space-y-3 text-sm">
          ...
          <div class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-800">
            <span class="text-gray-600 dark:text-gray-400">{{ t('security.session_duration', 'Session duration') }}</span>
            <code class="bg-gray-100 dark:bg-gray-800 px-2 py-0.5 rounded text-xs">SESSION_TTL_MINUTES</code>
          </div>
          <div class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-800">
            <span class="text-gray-600 dark:text-gray-400">{{ t('security.refresh_token_duration', 'Refresh token duration') }}</span>
            <code class="bg-gray-100 dark:bg-gray-800 px-2 py-0.5 rounded text-xs">REFRESH_TOKEN_TTL_DAYS</code>
          </div>
          <div class="flex justify-between items-center py-2">
            <span class="text-gray-600 dark:text-gray-400">{{ t('security.reset_link_expiry', 'Reset link expiry') }}</span>
